...
## [42.0.1](https://github.com/MrG9090/revm/compare/revm-database-v42.0.0...revm-database-v42.0.1) - 2026-08-20

### Fixed

- *(database)* cache newly created contract code ([#3855](https://github.com/MrG9090/revm/pull/3855))
