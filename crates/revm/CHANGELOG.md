...
## [40.0.4](https://github.com/MrG9090/revm/compare/revm-v40.0.3...revm-v40.0.4) - 2026-05-30

### Other

- updated the following local packages: revm-state, revm-database, revm-database-interface, revm-context-interface, revm-context, revm-interpreter, revm-precompile, revm-handler, revm-inspector, revm-statetest-types
