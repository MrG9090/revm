...
## [41.1.0](https://github.com/MrG9090/revm/compare/revm-database-v41.0.0...revm-database-v41.1.0) - 2026-07-01

### Added

- *(database)* add database fallback mode for BAL misses ([#3754](https://github.com/MrG9090/revm/pull/3754))

### Other

- *(database)* avoid double cloning in take_n_reverts ([#3539](https://github.com/MrG9090/revm/pull/3539))
- *(database)* use Option::filter in BundleAccount::take_info_revert ([#3730](https://github.com/MrG9090/revm/pull/3730))
