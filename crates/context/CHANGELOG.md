...
## [43.0.0](https://github.com/MrG9090/revm/compare/revm-context-v42.0.0...revm-context-v43.0.0) - 2026-08-20

### Added

- *(journal)* finalize selfdestructed accounts in place from Cancun ([#3863](https://github.com/MrG9090/revm/pull/3863))
- glamsterdam devnet-8 gas repricing ([#3850](https://github.com/MrG9090/revm/pull/3850))
- add async database fiber support ([#3709](https://github.com/MrG9090/revm/pull/3709))

### Fixed

- check call depth in CREATE pre-access checks (EIP-8037) ([#3829](https://github.com/MrG9090/revm/pull/3829))

### Other

- remove duplicate Amsterdam gas overrides and dead CPSB constants ([#3857](https://github.com/MrG9090/revm/pull/3857))

## [42.0.0](https://github.com/bluealloy/revm/compare/revm-context-v41.0.0...revm-context-v42.0.0) - 2026-07-22
...
- *(context)* keep is_empty on EIP-7702 account in load_account_delegated ([#3802](https://github.com/bluealloy/revm/pull/3802))
