...
## [43.0.1](https://github.com/MrG9090/revm/compare/revm-handler-v43.0.0...revm-handler-v43.0.1) - 2026-09-07

### Fixed

- reconcile sibling state gas refills ([#3893](https://github.com/MrG9090/revm/pull/3893))
- *(eip8037)* place the system call state-gas margin in the reservoir ([#3892](https://github.com/MrG9090/revm/pull/3892))
