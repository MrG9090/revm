...
## [17.0.1](https://github.com/MrG9090/revm/compare/revm-handler-v17.0.0...revm-handler-v17.0.1) - 2026-03-06

### Other

- updated the following local packages: revm-bytecode, revm-context-interface, revm-context, revm-interpreter, revm-precompile, revm-state, revm-database-interface, revm-database
