...
## [21.0.4](https://github.com/MrG9090/revm/compare/revm-inspector-v21.0.3...revm-inspector-v21.0.4) - 2026-05-30

### Other

- updated the following local packages: revm-state, revm-database, revm-database-interface, revm-context, revm-interpreter, revm-handler
