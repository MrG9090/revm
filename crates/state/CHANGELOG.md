...
## [42.0.1](https://github.com/MrG9090/revm/compare/revm-state-v42.0.0...revm-state-v42.0.1) - 2026-08-20

### Fixed

- *(state)* align Account's manual Deserialize field order with derived Serialize ([#3870](https://github.com/MrG9090/revm/pull/3870))

### Other

- *(deps)* replace unmaintained bincode with postcard in tests ([#3874](https://github.com/MrG9090/revm/pull/3874))
