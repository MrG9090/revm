...
## [36.0.1](https://github.com/MrG9090/revm/compare/revm-v36.0.0...revm-v36.0.1) - 2026-03-13

### Other

- updated the following local packages: revm-primitives, revm-bytecode, revm-context-interface, revm-context, revm-interpreter, revm-precompile, revm-handler, revm-inspector, revm-statetest-types, revm-state, revm-database-interface, revm-database
