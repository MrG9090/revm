...
## [41.1.0](https://github.com/MrG9090/revm/compare/revm-state-v41.0.0...revm-state-v41.1.0) - 2026-07-01

### Added

- *(state)* accept BAL account change slices ([#3762](https://github.com/MrG9090/revm/pull/3762))

### Fixed

- *(state)* re-baseline storage original_value only across tx boundaries ([#3746](https://github.com/MrG9090/revm/pull/3746))

### Other

- avoid intermediate BAL account allocation ([#3775](https://github.com/MrG9090/revm/pull/3775))
