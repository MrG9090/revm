...
## [42.0.0](https://github.com/MrG9090/revm/compare/revm-handler-v41.0.0...revm-handler-v42.0.0) - 2026-07-01

### Added

- make max refund quotient configurable ([#3757](https://github.com/MrG9090/revm/pull/3757))

### Fixed

- *(inspect)* finalize journal on error to prevent EIP-2929 warm set leak ([#3780](https://github.com/MrG9090/revm/pull/3780))
- faillible refund ([#3758](https://github.com/MrG9090/revm/pull/3758))
